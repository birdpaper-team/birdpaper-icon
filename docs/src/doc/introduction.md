...
这是一个基于开源图标 - [RemixIcon](https://remixicon.cn/) 生成的 `Vue3` 图标组件库，方便开发者在 `Vue` 组件中使用，并支持一些常用属性和操作，具体可以查看 [API 属性](/doc/api)。
...
再一次声明，这个项目仅用于学习和参考，不可用于商用；同时也希望你可以贡献代码，我们可以一起维护这个项目。