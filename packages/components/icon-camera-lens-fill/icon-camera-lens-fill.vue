...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-camera-lens-fill`, { [`${name}-spin`]: props.spin }]);
