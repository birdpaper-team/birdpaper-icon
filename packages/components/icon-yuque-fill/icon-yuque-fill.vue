...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-yuque-fill`, { [`${name}-spin`]: props.spin }]);
