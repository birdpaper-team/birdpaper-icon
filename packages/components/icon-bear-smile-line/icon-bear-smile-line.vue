...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-bear-smile-line`, { [`${name}-spin`]: props.spin }]);
