...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-ubuntu-fill`, { [`${name}-spin`]: props.spin }]);
