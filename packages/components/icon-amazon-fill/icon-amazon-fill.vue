...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-amazon-fill`, { [`${name}-spin`]: props.spin }]);
