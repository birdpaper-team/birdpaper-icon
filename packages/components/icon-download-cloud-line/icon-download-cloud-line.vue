...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-download-cloud-line`, { [`${name}-spin`]: props.spin }]);
