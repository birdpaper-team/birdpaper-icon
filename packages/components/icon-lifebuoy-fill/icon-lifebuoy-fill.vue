...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-lifebuoy-fill`, { [`${name}-spin`]: props.spin }]);
