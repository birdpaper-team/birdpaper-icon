...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-basketball-line`, { [`${name}-spin`]: props.spin }]);
