...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-instagram-fill`, { [`${name}-spin`]: props.spin }]);
