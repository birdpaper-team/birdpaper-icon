...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-javascript-fill`, { [`${name}-spin`]: props.spin }]);
