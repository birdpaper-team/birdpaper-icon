<template>
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" :class="iconClass" :style="innerStyle" @click="onClick"><path clip-rule="evenodd" d="m39.828 21.786-17.86 17.86c-3.414 3.414-9.03 3.332-12.545-.182-3.515-3.515-3.597-9.132-.182-12.546L27.1 9.058"></path><path d="m39.828 21.786-17.86 17.86c-3.414 3.414-9.03 3.332-12.545-.182-3.515-3.515-3.597-9.132-.182-12.546L27.1 9.058M8.734 27.424l26.144-.688" stroke="#333" stroke-width="4" stroke-linecap="round"></path><path d="M29.393 20.907a2 2 0 1 0-2.828-2.829 2 2 0 0 0 2.828 2.829ZM23.736 23.735a2 2 0 1 0-2.828-2.828 2 2 0 0 0 2.828 2.828Z" fill="#333"></path><path d="m23.564 5.522 19.8 19.8" stroke="#333" stroke-width="4" stroke-linecap="round"></path></svg>
</template>
