...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-tooth-line`, { [`${name}-spin`]: props.spin }]);
