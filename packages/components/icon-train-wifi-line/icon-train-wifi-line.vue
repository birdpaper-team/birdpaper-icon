...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-train-wifi-line`, { [`${name}-spin`]: props.spin }]);
