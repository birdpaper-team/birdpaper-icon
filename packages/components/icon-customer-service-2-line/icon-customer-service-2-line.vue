...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-customer-service-2-line`, { [`${name}-spin`]: props.spin }]);
