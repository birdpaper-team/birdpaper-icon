...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-line-fill`, { [`${name}-spin`]: props.spin }]);
