...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-weibo-fill`, { [`${name}-spin`]: props.spin }]);
