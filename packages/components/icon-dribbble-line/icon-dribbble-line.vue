...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-dribbble-line`, { [`${name}-spin`]: props.spin }]);
