...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-threads-fill`, { [`${name}-spin`]: props.spin }]);
