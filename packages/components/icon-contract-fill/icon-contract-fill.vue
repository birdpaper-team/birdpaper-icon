...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-contract-fill`, { [`${name}-spin`]: props.spin }]);
