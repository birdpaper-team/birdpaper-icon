...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-dribbble-fill`, { [`${name}-spin`]: props.spin }]);
