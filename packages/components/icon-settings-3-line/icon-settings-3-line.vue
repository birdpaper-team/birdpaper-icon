...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-settings-3-line`, { [`${name}-spin`]: props.spin }]);
