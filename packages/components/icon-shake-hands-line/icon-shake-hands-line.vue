...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-shake-hands-line`, { [`${name}-spin`]: props.spin }]);
