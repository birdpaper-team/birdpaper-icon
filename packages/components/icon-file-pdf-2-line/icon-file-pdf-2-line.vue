...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-file-pdf-2-line`, { [`${name}-spin`]: props.spin }]);
