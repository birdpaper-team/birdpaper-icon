...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-surgical-mask-fill`, { [`${name}-spin`]: props.spin }]);
