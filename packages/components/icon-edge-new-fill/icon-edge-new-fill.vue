...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-edge-new-fill`, { [`${name}-spin`]: props.spin }]);
