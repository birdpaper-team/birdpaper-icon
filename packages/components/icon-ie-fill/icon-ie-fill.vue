...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-ie-fill`, { [`${name}-spin`]: props.spin }]);
