...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-alibaba-cloud-fill`, { [`${name}-spin`]: props.spin }]);
