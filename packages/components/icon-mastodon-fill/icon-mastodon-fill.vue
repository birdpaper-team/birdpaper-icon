...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-mastodon-fill`, { [`${name}-spin`]: props.spin }]);
