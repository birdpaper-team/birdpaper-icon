...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-snapchat-line`, { [`${name}-spin`]: props.spin }]);
