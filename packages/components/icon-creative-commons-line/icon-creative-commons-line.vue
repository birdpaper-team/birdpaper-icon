...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-creative-commons-line`, { [`${name}-spin`]: props.spin }]);
