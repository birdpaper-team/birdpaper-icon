...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-telegram-line`, { [`${name}-spin`]: props.spin }]);
