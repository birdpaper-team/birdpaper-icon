...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-discount-percent-line`, { [`${name}-spin`]: props.spin }]);
