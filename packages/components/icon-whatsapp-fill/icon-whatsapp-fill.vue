...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-whatsapp-fill`, { [`${name}-spin`]: props.spin }]);
