...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-twitter-fill`, { [`${name}-spin`]: props.spin }]);
