...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-openai-fill`, { [`${name}-spin`]: props.spin }]);
