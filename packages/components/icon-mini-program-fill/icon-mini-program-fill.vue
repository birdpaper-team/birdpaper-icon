...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-mini-program-fill`, { [`${name}-spin`]: props.spin }]);
