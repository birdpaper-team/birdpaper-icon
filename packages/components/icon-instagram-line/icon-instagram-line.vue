...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-instagram-line`, { [`${name}-spin`]: props.spin }]);
