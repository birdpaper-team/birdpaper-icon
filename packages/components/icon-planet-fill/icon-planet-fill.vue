...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-planet-fill`, { [`${name}-spin`]: props.spin }]);
