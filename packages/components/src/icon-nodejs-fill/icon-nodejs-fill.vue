...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-nodejs-fill`, { [`${name}-spin`]: props.spin }]);
