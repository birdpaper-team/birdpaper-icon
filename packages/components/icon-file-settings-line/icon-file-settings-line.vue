...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-file-settings-line`, { [`${name}-spin`]: props.spin }]);
