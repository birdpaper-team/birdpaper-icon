...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-edge-new-line`, { [`${name}-spin`]: props.spin }]);
