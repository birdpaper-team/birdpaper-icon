...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-pencil-ruler-2-line`, { [`${name}-spin`]: props.spin }]);
