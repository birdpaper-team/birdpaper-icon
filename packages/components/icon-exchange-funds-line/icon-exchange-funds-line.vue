...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-exchange-funds-line`, { [`${name}-spin`]: props.spin }]);
