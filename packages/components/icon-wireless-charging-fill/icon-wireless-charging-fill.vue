...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-wireless-charging-fill`, { [`${name}-spin`]: props.spin }]);
