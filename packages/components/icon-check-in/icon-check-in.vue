<template>
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" :class="iconClass" :style="innerStyle" @click="onClick"><path d="m16 21 6.13-14.012a2 2 0 0 1 2.78-.96L36 12" :stroke="color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M26 31V12h16v29H26v-4" :stroke="color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4 44c9 0 9.77-5.317 12.33-5.688 3.023-.437 6.102-.662 8.773-1.312a51.55 51.55 0 0 0 7.26-2.355c.366-.152.671-.417.855-.769.563-1.081 1.572-3.466-.297-3.767-2.428-.39-9.94 2.474-13.793 1.953-3.853-.52-2.499-3.124-1.285-3.906C21.14 26.035 25 27 25 27v-9S10.334 21.75 5 28.156M32 21h10" :stroke="color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path></svg>
</template>
