...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-gallery-fill`, { [`${name}-spin`]: props.spin }]);
