...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-safari-fill`, { [`${name}-spin`]: props.spin }]);
