...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-centos-line`, { [`${name}-spin`]: props.spin }]);
