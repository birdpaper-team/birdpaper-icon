...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-qq-fill`, { [`${name}-spin`]: props.spin }]);
