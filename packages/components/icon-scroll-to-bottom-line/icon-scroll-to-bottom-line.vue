...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-scroll-to-bottom-line`, { [`${name}-spin`]: props.spin }]);
