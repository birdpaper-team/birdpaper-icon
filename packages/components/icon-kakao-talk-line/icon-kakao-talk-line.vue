...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-kakao-talk-line`, { [`${name}-spin`]: props.spin }]);
