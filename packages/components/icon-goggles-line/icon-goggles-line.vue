...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-goggles-line`, { [`${name}-spin`]: props.spin }]);
