...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-wechat-fill`, { [`${name}-spin`]: props.spin }]);
