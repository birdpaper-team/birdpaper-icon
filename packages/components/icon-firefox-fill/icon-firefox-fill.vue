...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-firefox-fill`, { [`${name}-spin`]: props.spin }]);
