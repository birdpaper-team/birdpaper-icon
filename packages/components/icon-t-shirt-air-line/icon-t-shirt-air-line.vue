...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-t-shirt-air-line`, { [`${name}-spin`]: props.spin }]);
