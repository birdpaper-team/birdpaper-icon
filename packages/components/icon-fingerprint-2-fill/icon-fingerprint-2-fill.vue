...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const iconClass = computed(() => [name, `${name}-fingerprint-2-fill`, { [`${name}-spin`]: props.spin }]);
